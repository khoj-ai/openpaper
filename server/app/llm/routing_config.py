...
class RoutingTask(str, Enum):
    ...
    MULTI_PAPER_RESPONSE = "multi_paper_response"
    CONVERSATION_TITLE = "conversation_title"
    DATA_TABLE_NAMING = "data_table_naming"
...
DEFAULT_TASK_PRIMARY: dict[RoutingTask, str] = {
    ...
    RoutingTask.CHAT_STREAM: LLMProvider.GEMINI.value,
    RoutingTask.EVIDENCE_GATHERING: LLMProvider.GROQ.value,
    RoutingTask.MULTI_PAPER_RESPONSE: LLMProvider.GEMINI.value,
    RoutingTask.CONVERSATION_TITLE: LLMProvider.GEMINI.value,
    RoutingTask.DATA_TABLE_NAMING: LLMProvider.GEMINI.value,
