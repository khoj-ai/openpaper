...
class PaperMetadataExtraction(BaseModel):
    ...
    publish_date: Optional[str] = Field(default=None, description="Publishing date of the paper")
    starter_questions: List[str] = Field(default=[], description="List of starter questions")
