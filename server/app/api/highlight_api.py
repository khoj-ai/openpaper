...
async def create_highlight(
    request: CreateHighlightRequest, db: Session = Depends(get_db)
) -> JSONResponse:
...
async def delete_highlight(
    highlight_id: str, db: Session = Depends(get_db)
) -> JSONResponse:
...
async def update_highlight(
    ...
    try:
        existing_highlight = highlight_crud.get(db, id=highlight_id)
