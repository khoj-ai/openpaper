...
export default function PaperView() {
    ...
    useEffect(() => {
        ...
        // Add function to fetch paper images
        async function fetchPaperImages() {
            setLoadingImages(true);
            try {
                const response: PaperImage[] = await fetchFromApi(`/api/paper/image/paper/${id}`);
