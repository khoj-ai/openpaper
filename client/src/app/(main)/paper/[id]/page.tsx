                                                ...
                                                <div className="flex-grow h-full overflow-hidden">
                                                    ...
                                                    }
                                                    {
                                                        rightSideFunction === 'Annotations' && (
                                                            <div className="flex flex-col h-[calc(100vh-128px)] md:px-2 overflow-y-auto">
                                                                <AnnotationsView
                                                                    annotations={annotations}
                                                                    highlights={highlights}
                                                    ...
                                                    }
                                                    {
                                                        rightSideFunction === 'Share' && paperData && (
                                                            <div className="flex flex-col h-[calc(100vh-128px)] p-4 space-y-4">
                                                ...
                                                <div className="flex flex-col h-[calc(100vh-128px)] md:px-2 overflow-y-auto">
                                        ...
                                        } */}
                                                    {
                                                        rightSideFunction === 'Overview' && paperData.summary && (
                                                            <div className="flex flex-col h-[calc(100vh-128px)] md:px-2 overflow-y-auto m-2 relative animate-fade-in">
                        ...
                        <>
                            {
                                rightSideFunction !== 'Focus' && (
                                    <div className="flex-grow h-full overflow-hidden">
                                        ...
                                        {
                                            rightSideFunction === 'Annotations' && (
                                                <div className="flex flex-col h-[calc(100vh-64px)] md:px-2 overflow-y-auto">
                                                    <AnnotationsView
                                                        annotations={annotations}
                                                        highlights={highlights}
                                                        onHighlightClick={handleHighlightClick}
                                        ...
                                        {
                                            rightSideFunction === 'Overview' && paperData.summary && (
                                                <div className="flex flex-col h-[calc(100vh-64px)] md:px-2 overflow-y-auto m-2 relative animate-fade-in">
                                                    {/* Paper Metadata Section */}
                                                    <div className="prose dark:prose-invert !max-w-full text-sm">
                                                        {paperData.title && (
                                                            <h1 className="text-2xl font-bold">{paperData.title}</h1>
