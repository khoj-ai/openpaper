export const metadata = {
    ...
    description: "A 6,211-question benchmark for single-paper scientific QA, paired with a deterministic citation matcher that discriminates frontier models 4× more sharply than LLM-judge metrics.",
    date: "05-08-2026",
...
![Citation Precision by Domain](/benchmark/domain_heatmap_precision.png)
...
![Citation Accuracy: Lookup vs Multi-hop](/benchmark/dumbbell_citation_accuracy.png)
