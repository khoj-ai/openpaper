...
Today we're launching Open Paper v0.1, a research application designed to transform how researchers interact with scholarly literature. We've built Open Paper to address the challenges researchers face when working with academic papers, from organization to comprehension to collaboration.

![Open Paper v0.1](/openpaper_still_v01.png)
